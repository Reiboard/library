...
for i in g:
    if ':' in i:
        ...
        cmds.window( width=300, t = 'picker' )
        ...
        cmds.button( label='switch_IK_FK_legL', command=switch_IK_FK_legL)
        cmds.button( label='switch_IK_FK_legR', command=switch_IK_FK_legR)
